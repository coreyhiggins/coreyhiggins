...
[**blastradius**](https://github.com/coreyhiggins/blastradius) guards AI coding agents against shell commands that leave your machine.
...
| | |
|---|---|
| [linux-deploy-toolkit](https://github.com/coreyhiggins/linux-deploy-toolkit) | Versioned releases, atomic symlink swap, health check, automatic rollback |
| [jvm-shutdown-watchdog](https://github.com/coreyhiggins/jvm-shutdown-watchdog) | Forces a wedged JVM to exit and names the threads that wedged it |
| [failsoft-webhook](https://github.com/coreyhiggins/failsoft-webhook) | Webhook alerting that cannot block, throw, or hold the process open |
| [service-health-monitor](https://github.com/coreyhiggins/service-health-monitor) | Endpoint and unit checks on a timer, alerting on state change rather than every run |
| [mcp-server-example](https://github.com/coreyhiggins/mcp-server-example) | Dependency-free Model Context Protocol server over stdio |
